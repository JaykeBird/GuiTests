...
namespace ParticleEmitter
{
    ...
    /// </summary>
    public class NewParticleEmitter : Control, IDisposable
    {
        ...
        public static readonly DependencyProperty ParticleBrushProperty
            = DependencyProperty.Register(nameof(ParticleBrush), typeof(Brush), typeof(NewParticleEmitter),
        ...
        public static readonly DependencyProperty MaxCountProperty
            = DependencyProperty.Register(nameof(MaxCount), typeof(int), typeof(NewParticleEmitter),
        ...
        public static readonly DependencyProperty MinLifeProperty
            = DependencyProperty.Register(nameof(MinLife), typeof(int), typeof(NewParticleEmitter),
        ...
        public static readonly DependencyProperty MaxLifeProperty
            = DependencyProperty.Register(nameof(MaxLife), typeof(int), typeof(NewParticleEmitter),
        ...
        public static readonly DependencyProperty ParticleDirectionProperty
            = DependencyProperty.Register(nameof(ParticleDirection), typeof(Vector), typeof(NewParticleEmitter),
        ...
        public static readonly DependencyProperty MinSpeedProperty
            = DependencyProperty.Register(nameof(MinSpeed), typeof(double), typeof(NewParticleEmitter),
        ...
        public static readonly DependencyProperty MaxSpeedProperty
            = DependencyProperty.Register(nameof(MaxSpeed), typeof(double), typeof(NewParticleEmitter),
        ...
        public static readonly DependencyProperty MinSizeProperty
            = DependencyProperty.Register(nameof(MinSize), typeof(Size), typeof(NewParticleEmitter),
        ...
        public static readonly DependencyProperty MaxSizeProperty
            = DependencyProperty.Register(nameof(MaxSize), typeof(Size), typeof(NewParticleEmitter),
        ...
        public static readonly DependencyProperty ChangeSizeWhileAliveProperty
            = DependencyProperty.Register(nameof(ChangeSizeWhileAlive), typeof(bool), typeof(NewParticleEmitter),
        ...
        public static readonly DependencyProperty ChangeDirectionWhileAliveProperty
            = DependencyProperty.Register(nameof(ChangeDirectionWhileAlive), typeof(bool), typeof(NewParticleEmitter),
            new FrameworkPropertyMetadata(false));
        ...
        public static readonly DependencyProperty SizeChangeVarianceProperty
            = DependencyProperty.Register(nameof(SizeChangeVariance), typeof(double), typeof(NewParticleEmitter),
            new FrameworkPropertyMetadata(5.0));
        ...
        public static readonly DependencyProperty DirectionChangeVarianceProperty
            = DependencyProperty.Register(nameof(DirectionChangeVariance), typeof(double), typeof(NewParticleEmitter),
            new FrameworkPropertyMetadata(1.0));
        ...
        public static readonly DependencyProperty VarianceCooldownProperty
            = DependencyProperty.Register(nameof(VarianceCooldown), typeof(int), typeof(NewParticleEmitter),
            new FrameworkPropertyMetadata(5));
        ...
        public static readonly DependencyProperty UpdateRateProperty
            = DependencyProperty.Register(nameof(UpdateRate), typeof(int), typeof(NewParticleEmitter),
        ...
        public static readonly DependencyProperty EmitRateProperty
            = DependencyProperty.Register(nameof(EmitRate), typeof(int), typeof(NewParticleEmitter),
            new FrameworkPropertyMetadata(1));
        ...
        public static readonly DependencyProperty EmitCountMinProperty
            = DependencyProperty.Register(nameof(EmitCountMin), typeof(uint), typeof(NewParticleEmitter),
        ...
        public static readonly DependencyProperty EmitCountMaxProperty
            = DependencyProperty.Register(nameof(EmitCountMax), typeof(uint), typeof(NewParticleEmitter),
        ...
        Action<NewParticleEmitter> threadRun = (NewParticleEmitter pe) =>
        {
